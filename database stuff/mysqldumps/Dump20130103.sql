...
CREATE TABLE `jobs` (
  ...
  `updated_by` varchar(255) NOT NULL,
  PRIMARY KEY (`job_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7000047 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `job_parts` (
  `job_parts_id` int(11) NOT NULL AUTO_INCREMENT,
  `transaction_id` int(11) NOT NULL,
  `part_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `created_by` varchar(255) NOT NULL,
  PRIMARY KEY (`job_parts_id`)
...
INSERT INTO `job_parts` VALUES (1,102,2,'2012-12-27 11:12:58','Steven Woodhouse'),(2,109,2,'2012-12-28 10:40:45','Steven Woodhouse'),(3,111,2,'2012-12-28 10:46:54','Steven Woodhouse'),(4,113,2,'2012-12-28 10:49:29','Steven Woodhouse'),(5,115,2,'2012-12-28 11:07:17','Steven Woodhouse'),(6,117,2,'2012-12-28 11:10:38','Steven Woodhouse'),(7,119,2,'2012-12-28 11:20:45','Steven Woodhouse'),(8,121,2,'2012-12-28 11:25:18','Steven Woodhouse'),(9,125,3,'2012-12-28 11:39:26','Steven Woodhouse'),(10,126,2,'2012-12-28 11:39:48','Steven Woodhouse'),(11,130,2,'2012-12-28 11:42:45','Steven Woodhouse'),(12,131,3,'2012-12-28 11:42:55','Steven Woodhouse'),(13,135,2,'2012-12-28 12:04:18','Steven Woodhouse'),(14,139,2,'2012-12-28 12:08:04','Steven Woodhouse'),(15,140,3,'2012-12-28 12:08:04','Steven Woodhouse'),(16,147,2,'2012-12-28 12:16:23','Steven Woodhouse'),(17,148,3,'2012-12-28 12:16:34','Steven Woodhouse');
...
INSERT INTO `job_repairs` VALUES (1,91,7,9,'2012-12-19 07:57:48','Steven Woodhouse'),(2,92,7,9,'2012-12-19 07:58:35','Steven Woodhouse'),(3,93,7,9,'2012-12-19 07:59:59','Steven Woodhouse'),(4,94,7,9,'2012-12-19 08:16:44','Steven Woodhouse'),(5,95,7,10,'2012-12-19 08:27:58','Steven Woodhouse'),(6,96,7,9,'2012-12-19 08:36:22','Steven Woodhouse'),(7,102,1,4,'2012-12-27 11:12:58','Steven Woodhouse'),(8,109,1,4,'2012-12-28 10:40:45','Steven Woodhouse'),(9,111,1,4,'2012-12-28 10:46:54','Steven Woodhouse'),(10,113,1,4,'2012-12-28 10:49:29','Steven Woodhouse'),(11,115,1,4,'2012-12-28 11:07:17','Steven Woodhouse'),(12,117,1,4,'2012-12-28 11:10:38','Steven Woodhouse'),(13,119,1,4,'2012-12-28 11:20:45','Steven Woodhouse'),(14,121,1,4,'2012-12-28 11:25:18','Steven Woodhouse'),(15,125,4,2,'2012-12-28 11:39:26','Steven Woodhouse'),(16,126,1,4,'2012-12-28 11:39:48','Steven Woodhouse'),(17,130,1,4,'2012-12-28 11:42:45','Steven Woodhouse'),(18,131,4,2,'2012-12-28 11:42:55','Steven Woodhouse'),(19,135,1,4,'2012-12-28 12:04:18','Steven Woodhouse'),(20,139,1,4,'2012-12-28 12:08:04','Steven Woodhouse'),(21,140,4,2,'2012-12-28 12:08:04','Steven Woodhouse'),(22,147,1,4,'2012-12-28 12:16:23','Steven Woodhouse'),(23,148,4,2,'2012-12-28 12:16:34','Steven Woodhouse');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `process_part` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `process_part`(in job_id_in int, part_description_in varchar(255), user_name_in varchar(255), fault_in varchar(255), 
repair_in varchar(255), reason_in varchar(255))
BEGIN
-- get some variables
set @date_time_stamp = (select convert(now(), char));

-- as this could be either add, replace or resolder part, check to see what it is first before adding in the transaction
set @transaction_type_id = case when repair_in = 'Add Part' then 6
                                when repair_in = 'Replace Part' then 7
                                when repair_in = 'Resolder Part' then 8 end;

-- add in transaction
insert transactions (job_id, transaction_type_id, notes, created_at, created_by)
select job_id_in, @transaction_type_id, '', @date_time_stamp,  user_name_in;

-- get the transactionid
set @transaction_id = (select max(transaction_id) from transactions t where t.job_id = job_id_in and transaction_type_id = @transaction_type_id);

-- get the fault, repair and reason id's
set @fault_id = (select fault_id from faults f where f.fault_description = fault_in);
set @reason_id = (select repair_reason_id from repair_reasons rr where rr.repair_reason = reason_in);
set @repair_id = (select distinct upr.repair_id from 
part_model_fault_repair_reason_map pm inner join 
part_on_models pom on pm.part_on_models_id = pom.part_on_models_id inner join 
fault_repair_reason_map frr on pm.fault_repair_reason_map_id = frr.fault_repair_reason_map_id inner join 
ui_part_repair_map upr on frr.repair_id = upr.repair_id inner join 
parts p on pom.part_id = p.part_id
where frr.reason_id = @reason_id and 
frr.fault_id = @fault_id and 
upr.ui_repair_name = repair_in and 
part_description = part_description_in);

-- insert the job_fault
insert job_faults (transaction_id, fault_id, fault_order, created_at, created_by)
select @transaction_id, @fault_id, 1, @date_time_stamp, user_name_in;


-- insert the job_repair & reason
insert job_repairs (transaction_id, repair_id, repair_reason_id, created_at, created_by)
select @transaction_id, @repair_id, @reason_id, @date_time_stamp, user_name_in;


-- get part id
set @part_id = (select part_id from parts where part_description = part_description_in);

-- insert the part
insert job_parts (transaction_id, part_id, created_at, created_by)
select @transaction_id, @fault_id, @date_time_stamp, user_name_in;
...
-- Dump completed on 2013-01-03 15:52:47
